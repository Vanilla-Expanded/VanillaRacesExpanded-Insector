...
{
    public class QuestNode_Root_ChestburstWandererJoin_WalkIn : QuestNode_Root_WandererJoin
    {
        ...
        public override Pawn GeneratePawn()
        {
            ...
            pawn.health.AddHediff(InternalDefOf.VRE_ChestburstPregnancy_Victim_Hidden, null, null, null);
