...
{
    public class HediffGiver_HypothermicSlowdown : HediffGiver
    {
     

        public override void OnIntervalPassed(Pawn pawn, Hediff cause)
        {
            if (!pawn.HasActiveGene(InternalDefOf.VRE_HypothermicSlowdown))
            {
                return;
            }
            ...
            HediffDef hediffDef = InternalDefOf.HypothermicSlowdown;
